#![doc = "Peripheral access API for PSOC6_02 microcontrollers (generated using svd2rust v0.17.0 (8b95499 2020-07-05))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
// auto generated family number, placed by the devgen.sh script
#[doc = r"The family number for the PSOC device"]
pub const PSOC_FAMILY:u8 =  2  ; 
