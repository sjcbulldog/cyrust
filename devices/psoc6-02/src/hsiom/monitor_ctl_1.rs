#[doc = "Reader of register MONITOR_CTL_1"]
pub type R = crate::R<u32, super::MONITOR_CTL_1>;
#[doc = "Writer for register MONITOR_CTL_1"]
pub type W = crate::W<u32, super::MONITOR_CTL_1>;
#[doc = "Register MONITOR_CTL_1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MONITOR_CTL_1 {
    #[inline(always)]
