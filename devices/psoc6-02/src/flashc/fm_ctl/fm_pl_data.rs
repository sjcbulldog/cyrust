#[doc = "Reader of register FM_PL_DATA[%s]"]
pub type R = crate::R<u32, super::FM_PL_DATA>;
#[doc = "Writer for register FM_PL_DATA[%s]"]
pub type W = crate::W<u32, super::FM_PL_DATA>;
#[doc = "Register FM_PL_DATA[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::FM_PL_DATA {
    #[inline(always)]
