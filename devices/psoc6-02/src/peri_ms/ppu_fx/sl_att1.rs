#[doc = "Reader of register SL_ATT1"]
pub type R = crate::R<u32, super::SL_ATT1>;
#[doc = "Writer for register SL_ATT1"]
pub type W = crate::W<u32, super::SL_ATT1>;
#[doc = "Register SL_ATT1 `reset()`'s with value 0x1f1f_1f1f"]
impl crate::ResetValue for super::SL_ATT1 {
    #[inline(always)]
...
#[doc = "Write proxy for field `PC4_UR`"]
...
#[doc = "Write proxy for field `PC4_PR`"]
...
#[doc = "Write proxy for field `PC5_UR`"]
...
#[doc = "Write proxy for field `PC5_PR`"]
...
#[doc = "Write proxy for field `PC6_UR`"]
...
#[doc = "Write proxy for field `PC6_PR`"]
...
#[doc = "Write proxy for field `PC7_UR`"]
...
#[doc = "Write proxy for field `PC7_PR`"]
