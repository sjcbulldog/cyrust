#[doc = "Reader of register SL_ATT2"]
pub type R = crate::R<u32, super::SL_ATT2>;
#[doc = "Writer for register SL_ATT2"]
pub type W = crate::W<u32, super::SL_ATT2>;
#[doc = "Register SL_ATT2 `reset()`'s with value 0x1f1f_1f1f"]
impl crate::ResetValue for super::SL_ATT2 {
    #[inline(always)]
...
#[doc = "Write proxy for field `PC8_UR`"]
...
#[doc = "Write proxy for field `PC8_PR`"]
...
#[doc = "Write proxy for field `PC9_UR`"]
...
#[doc = "Write proxy for field `PC9_PR`"]
...
#[doc = "Write proxy for field `PC10_UR`"]
...
#[doc = "Write proxy for field `PC10_PR`"]
...
#[doc = "Write proxy for field `PC11_UR`"]
...
#[doc = "Write proxy for field `PC11_PR`"]
