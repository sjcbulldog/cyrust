#[doc = "Reader of register MONITOR_CTL_2"]
pub type R = crate::R<u32, super::MONITOR_CTL_2>;
#[doc = "Writer for register MONITOR_CTL_2"]
pub type W = crate::W<u32, super::MONITOR_CTL_2>;
#[doc = "Register MONITOR_CTL_2 `reset()`'s with value 0"]
impl crate::ResetValue for super::MONITOR_CTL_2 {
    type Type = u32;
    #[inline(always)]
