#[doc = "Reader of register SL_ATT0"]
pub type R = crate::R<u32, super::SL_ATT0>;
#[doc = "Writer for register SL_ATT0"]
pub type W = crate::W<u32, super::SL_ATT0>;
#[doc = "Register SL_ATT0 `reset()`'s with value 0x1f1f_1f1f"]
impl crate::ResetValue for super::SL_ATT0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `PC1_UR`"]
...
#[doc = "Write proxy for field `PC1_PR`"]
...
#[doc = "Write proxy for field `PC2_UR`"]
...
#[doc = "Write proxy for field `PC2_PR`"]
...
#[doc = "Write proxy for field `PC3_UR`"]
...
#[doc = "Write proxy for field `PC3_PR`"]
