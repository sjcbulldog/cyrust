...
#[doc = "Reader of field `CLOCK_LS_SEL`"]
pub type CLOCK_LS_SEL_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CLOCK_LS_SEL`"]
pub struct CLOCK_LS_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> CLOCK_LS_SEL_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn clock_ls_sel(&self) -> CLOCK_LS_SEL_R {
        CLOCK_LS_SEL_R::new(((self.bits >> 7) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - Low speed (LS) generator clock source selection 1: select clk_mf 0: select clk_lf"]
    #[inline(always)]
    pub fn clock_ls_sel(&mut self) -> CLOCK_LS_SEL_W {
        CLOCK_LS_SEL_W { w: self }
    }
    #[doc = "Bits 8:11 - The number of COM connections minus 2. So: 0: 2 COM's 1: 3 COM's ... 13: 15 COM's 14: 16 COM's 15: undefined"]
    #[inline(always)]
