...
impl Acquire {
    ...
    #[doc = "Secure/on-secure access control: '0': secure. '1': non-secure. This field is set with the secure/non-secure access control of the access that successfully acquired the lock."]
    #[inline(always)]
...
impl LockStatus {
    ...
    #[doc = "This field specifies the cecure/on-secure access control: '0': secure. '1': non-secure."]
    #[inline(always)]
    pub const fn ns(&self) -> bool {
        let val = (self.0 >> 1usize) & 0x01;
        val != 0
