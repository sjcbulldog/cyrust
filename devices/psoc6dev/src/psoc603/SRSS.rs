...
impl Srss {
    ...
    #[doc = "Medium Frequency Clock Select Register"]
    #[inline(always)]
    pub const fn clk_mf_select(self) -> crate::common::Reg<ClkMfSelect, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(1348usize) as _) }
    }
    #[doc = "MFO Configuration Register"]
    #[inline(always)]
    pub const fn clk_mfo_config(self) -> crate::common::Reg<ClkMfoConfig, crate::common::RW> {
...
impl ClkImoConfig {
    #[doc = "Master enable for IMO oscillator. This bit must be high at all times for all functions to work properly. Hardware will automatically disable the IMO during HIBERNATE and XRES. It will automatically disable during DEEPSLEEP if CLK_MFO_CONFIG.DPSLP_ENABLE==0."]
    #[inline(always)]
    pub const fn enable(&self) -> bool {
        let val = (self.0 >> 31usize) & 0x01;
        val != 0
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct ClkMfSelect(pub u32);
impl ClkMfSelect {
    ...
    #[inline(always)]
    pub const fn mfclk_sel(&self) -> MfclkSel {
        let val = (self.0 >> 0usize) & 0x07;
        MfclkSel::from_bits(val as u8)
    }
    #[doc = "Select source for MFCLK (clk_mf). Note that not all products support all clock sources. Selecting a clock source that is not supported results in undefined behavior."]
    #[inline(always)]
    pub fn set_mfclk_sel(&mut self, val: MfclkSel) {
        self.0 = (self.0 & !(0x07 << 0usize)) | (((val.to_bits() as u32) & 0x07) << 0usize);
    }
    #[doc = "Divide selected clock source by (1+MFCLK_DIV). The output of this divider is MFCLK (clk_mf). Allows for integer divisions in the range \\[1, 256\\]. Do not change this setting while ENABLE==1."]
    #[inline(always)]
    pub const fn mfclk_div(&self) -> u8 {
        let val = (self.0 >> 8usize) & 0xff;
        val as u8
    }
    #[doc = "Divide selected clock source by (1+MFCLK_DIV). The output of this divider is MFCLK (clk_mf). Allows for integer divisions in the range \\[1, 256\\]. Do not change this setting while ENABLE==1."]
    #[inline(always)]
    pub fn set_mfclk_div(&mut self, val: u8) {
        self.0 = (self.0 & !(0xff << 8usize)) | (((val as u32) & 0xff) << 8usize);
    }
    #[doc = "Enable for MFCLK (clk_mf)."]
    #[inline(always)]
    pub const fn enable(&self) -> bool {
        let val = (self.0 >> 31usize) & 0x01;
        val != 0
...
impl Default for ClkMfSelect {
    #[inline(always)]
    fn default() -> ClkMfSelect {
        ClkMfSelect(0)
    }
}
#[doc = "MFO Configuration Register"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct ClkMfoConfig(pub u32);
impl ClkMfoConfig {
    #[doc = "Enable for MFO during DEEPSLEEP. This bit is ignored when ENABLE==0. When ENABLE==1: 0: MFO is automatically disabled during DEEPSLEEP and enables upon wakeup; 1: MFO is kept enabled throughout DEEPSLEEP"]
    #[inline(always)]
    pub const fn dpslp_enable(&self) -> bool {
        let val = (self.0 >> 30usize) & 0x01;
        val != 0
    }
    #[doc = "Enable for MFO during DEEPSLEEP. This bit is ignored when ENABLE==0. When ENABLE==1: 0: MFO is automatically disabled during DEEPSLEEP and enables upon wakeup; 1: MFO is kept enabled throughout DEEPSLEEP"]
    #[inline(always)]
    pub fn set_dpslp_enable(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val as u32) & 0x01) << 30usize);
    }
    #[doc = "Enable for MFO."]
    #[inline(always)]
...
impl Default for ClkMfoConfig {
    #[inline(always)]
    fn default() -> ClkMfoConfig {
        ClkMfoConfig(0)
    }
}
#[doc = "Fast Clock Output Select Register"]
...
impl MfclkSel {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> MfclkSel {
        unsafe { core::mem::transmute(val & 0x07) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for MfclkSel {
    #[inline(always)]
    fn from(val: u8) -> MfclkSel {
        MfclkSel::from_bits(val)
    }
}
impl From<MfclkSel> for u8 {
    #[inline(always)]
    fn from(val: MfclkSel) -> u8 {
        MfclkSel::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Eq, PartialEq, Ord, PartialOrd)]
