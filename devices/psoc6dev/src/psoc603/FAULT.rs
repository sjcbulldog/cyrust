...
impl Struct {
    ...
    #[doc = "Fault data"]
    #[inline(always)]
    pub const fn data(self, n: usize) -> crate::common::Reg<Data, crate::common::RW> {
        assert!(n < 4usize);
...
impl Data {
    #[doc = "Captured fault source data. Note: the DATA registers can only be written when STATUS.VALID is '0'. Note: the fault source index STATUS.IDX specifies the format of the DATA registers."]
    #[inline(always)]
...
impl Pending0 {
    #[doc = "This field specifies the following sources: Bit 0: CM0 MPU. Bit 1: CRYPTO MPU. Bit 2: DW 0 MPU. Bit 3: DW 1 MPU. Bit 4: DMA controller MPU. ... Bit 15: DAP MPU. Bit 16: CM4 system bus MPU. Bit 17: CM4 code bus MPU (for non FLASH controller accesses). Bit 18: CM4 code bus MPU (for FLASH controller accesses)."]
    #[inline(always)]
    pub const fn source(&self) -> u32 {
        let val = (self.0 >> 0usize) & 0xffff_ffff;
        val as u32
...
impl Pending2 {
    #[doc = "This field specifies the following sources: Bit 0 - 31: See STATUS register."]
    #[inline(always)]
    pub const fn source(&self) -> u32 {
        let val = (self.0 >> 0usize) & 0xffff_ffff;
        val as u32
