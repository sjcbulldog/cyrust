...
impl Hsiom {
    ...
    #[inline(always)]
    pub const fn monitor_ctl_0(self) -> crate::common::Reg<MonitorCtl0, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8704usize) as _) }
    }
    #[doc = "Power/Ground Monitor cell control 1"]
    #[inline(always)]
    pub const fn monitor_ctl_1(self) -> crate::common::Reg<MonitorCtl1, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8708usize) as _) }
    }
    #[doc = "Power/Ground Monitor cell control 2"]
    #[inline(always)]
    pub const fn monitor_ctl_2(self) -> crate::common::Reg<MonitorCtl2, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8712usize) as _) }
    }
    #[doc = "Power/Ground Monitor cell control 3"]
    #[inline(always)]
    pub const fn monitor_ctl_3(self) -> crate::common::Reg<MonitorCtl3, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8716usize) as _) }
    }
    #[doc = "Alternate JTAG IF selection register"]
    #[inline(always)]
    pub const fn alt_jtag_en(self) -> crate::common::Reg<AltJtagEn, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8768usize) as _) }
    }
}
#[doc = "HSIOM port registers"]
#[derive(Copy, Clone, Eq, PartialEq)]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct AltJtagEn(pub u32);
impl AltJtagEn {
    #[doc = "Provides the selection for alternate JTAG IF connectivity. 0: Primary JTAG interface is selected 1: Secondary (alternate) JTAG interface is selected. This connectivity works ONLY in ACTIVE mode."]
    #[inline(always)]
...
impl Default for AltJtagEn {
    #[inline(always)]
    fn default() -> AltJtagEn {
        AltJtagEn(0)
    }
}
#[doc = "AMUX splitter cell control"]
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MonitorCtl0(pub u32);
impl MonitorCtl0 {
    #[doc = "control for switch, which connects the power/ground supply to AMUXBUS_A/B respectively when switch is closed: '0': switch open. '1': switch closed."]
    #[inline(always)]
    pub const fn monitor_en(&self) -> u32 {
        let val = (self.0 >> 0usize) & 0xffff_ffff;
        val as u32
    }
    #[doc = "control for switch, which connects the power/ground supply to AMUXBUS_A/B respectively when switch is closed: '0': switch open. '1': switch closed."]
    #[inline(always)]
    pub fn set_monitor_en(&mut self, val: u32) {
        self.0 = (self.0 & !(0xffff_ffff << 0usize)) | (((val as u32) & 0xffff_ffff) << 0usize);
    }
}
impl Default for MonitorCtl0 {
    #[inline(always)]
    fn default() -> MonitorCtl0 {
        MonitorCtl0(0)
    }
}
#[doc = "Power/Ground Monitor cell control 1"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MonitorCtl1(pub u32);
impl MonitorCtl1 {
    #[doc = "control for switch, which connects the power/ground supply to AMUXBUS_A/B respectively when switch is closed: '0': switch open. '1': switch closed."]
    #[inline(always)]
    pub const fn monitor_en(&self) -> u32 {
...
impl Default for MonitorCtl1 {
    #[inline(always)]
    fn default() -> MonitorCtl1 {
        MonitorCtl1(0)
    }
}
#[doc = "Power/Ground Monitor cell control 2"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MonitorCtl2(pub u32);
impl MonitorCtl2 {
    #[doc = "control for switch, which connects the power/ground supply to AMUXBUS_A/B respectively when switch is closed: '0': switch open. '1': switch closed."]
    #[inline(always)]
    pub const fn monitor_en(&self) -> u32 {
...
impl Default for MonitorCtl2 {
    #[inline(always)]
    fn default() -> MonitorCtl2 {
        MonitorCtl2(0)
    }
}
#[doc = "Power/Ground Monitor cell control 3"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct MonitorCtl3(pub u32);
impl MonitorCtl3 {
    #[doc = "control for switch, which connects the power/ground supply to AMUXBUS_A/B respectively when switch is closed: '0': switch open. '1': switch closed."]
    #[inline(always)]
    pub const fn monitor_en(&self) -> u32 {
...
impl Default for MonitorCtl3 {
    #[inline(always)]
    fn default() -> MonitorCtl3 {
        MonitorCtl3(0)
    }
}
#[doc = "Port selection 0"]
