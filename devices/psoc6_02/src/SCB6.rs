...
impl Scb0 {
    ...
    #[inline(always)]
    pub const fn cmd_resp_ctrl(self) -> crate::common::Reg<CmdRespCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(8usize) as _) }
    }
    #[doc = "Command/response status"]
    #[inline(always)]
    pub const fn cmd_resp_status(self) -> crate::common::Reg<CmdRespStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(12usize) as _) }
    }
    #[doc = "SPI control"]
    #[inline(always)]
    pub const fn spi_ctrl(self) -> crate::common::Reg<SpiCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(32usize) as _) }
    }
    #[doc = "SPI status"]
    #[inline(always)]
    pub const fn spi_status(self) -> crate::common::Reg<SpiStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(36usize) as _) }
    }
    #[doc = "UART control"]
    #[inline(always)]
    pub const fn uart_ctrl(self) -> crate::common::Reg<UartCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(64usize) as _) }
    }
    #[doc = "UART transmitter control"]
    #[inline(always)]
    pub const fn uart_tx_ctrl(self) -> crate::common::Reg<UartTxCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(68usize) as _) }
    }
    #[doc = "UART receiver control"]
    #[inline(always)]
    pub const fn uart_rx_ctrl(self) -> crate::common::Reg<UartRxCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(72usize) as _) }
    }
    #[doc = "UART receiver status"]
    #[inline(always)]
    pub const fn uart_rx_status(self) -> crate::common::Reg<UartRxStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(76usize) as _) }
    }
    #[doc = "UART flow control"]
    #[inline(always)]
    pub const fn uart_flow_ctrl(self) -> crate::common::Reg<UartFlowCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(80usize) as _) }
    }
    #[doc = "I2C control"]
    #[inline(always)]
    pub const fn i2c_ctrl(self) -> crate::common::Reg<I2cCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(96usize) as _) }
    }
    #[doc = "I2C status"]
    #[inline(always)]
    pub const fn i2c_status(self) -> crate::common::Reg<I2cStatus, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(100usize) as _) }
    }
    #[doc = "I2C master command"]
    #[inline(always)]
    pub const fn i2c_m_cmd(self) -> crate::common::Reg<I2cMCmd, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(104usize) as _) }
    }
    #[doc = "I2C slave command"]
    #[inline(always)]
    pub const fn i2c_s_cmd(self) -> crate::common::Reg<I2cSCmd, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(108usize) as _) }
    }
    #[doc = "I2C configuration"]
    #[inline(always)]
    pub const fn i2c_cfg(self) -> crate::common::Reg<I2cCfg, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(112usize) as _) }
    }
    #[doc = "Transmitter control"]
    #[inline(always)]
    pub const fn tx_ctrl(self) -> crate::common::Reg<TxCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(512usize) as _) }
    }
    #[doc = "Transmitter FIFO control"]
    #[inline(always)]
    pub const fn tx_fifo_ctrl(self) -> crate::common::Reg<TxFifoCtrl, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn rx_ctrl(self) -> crate::common::Reg<RxCtrl, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.add(768usize) as _) }
    }
    #[doc = "Receiver FIFO control"]
    #[inline(always)]
    pub const fn rx_fifo_ctrl(self) -> crate::common::Reg<RxFifoCtrl, crate::common::RW> {
    ...
    #[inline(always)]
    pub const fn rx_match(self) -> crate::common::Reg<RxMatch, crate::common::RW> {
...
impl Ctrl {
    ...
    #[doc = "N/A"]
    #[inline(always)]
    pub const fn mode(&self) -> CtrlMode {
        let val = (self.0 >> 24usize) & 0x03;
        CtrlMode::from_bits(val as u8)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn set_mode(&mut self, val: CtrlMode) {
...
impl I2cCfg {
    ...
    #[doc = "Trim bits for 'i2c_scl_in' 50 ns filter. See s8i2cs BROS (001-59539) for more details on the trim bit values."]
    #[inline(always)]
...
impl IntrM {
    ...
    #[doc = "SPI master transfer done event: all data frames in the transmit FIFO are sent, the transmit FIFO is empty (both TX FIFO and transmit shifter register are empty), and SPI select output pin is deselected."]
    #[inline(always)]
...
impl IntrRx {
    #[doc = "More entries in the RX FIFO than the value specified by RX_FIFO_CTRL.TRIGGER_LEVEL. Only used in FIFO mode."]
    #[inline(always)]
...
impl IntrTx {
    #[doc = "Less entries in the TX FIFO than the value specified by TX_FIFO_CTRL.TRIGGER_LEVEL. Only used in FIFO mode."]
    #[inline(always)]
    pub const fn trigger(&self) -> bool {
        let val = (self.0 >> 0usize) & 0x01;
        val != 0
    ...
    #[doc = "UART transmitter done event. This happens when the IP is done transferring all data in the TX FIFO, and the last stop field is transmitted (both TX FIFO and transmit shifter register are empty). Set to '1', when event is detected. Write with '1' to clear bit."]
    #[inline(always)]
...
impl SpiCtrl {
    #[doc = "Continuous SPI data transfers enabled ('1') or not ('0'). This field is used in master mode. In slave mode, both continuous and non-continuous SPI data transfers are supported independent of this field. When continuous transfers are enabled individual data frame transfers are not necessarily separated by slave deselection (as indicated by the level or pulse on the SELECT line): if the TX FIFO has multiple data frames, data frames are send out without slave deselection. When continuous transfers are not enabled individual data frame transfers are always separated by slave deselection: independent of the availability of TX FIFO data frames."]
    #[inline(always)]
    pub const fn ssel_continuous(&self) -> bool {
        let val = (self.0 >> 0usize) & 0x01;
        val != 0
    }
    #[doc = "Continuous SPI data transfers enabled ('1') or not ('0'). This field is used in master mode. In slave mode, both continuous and non-continuous SPI data transfers are supported independent of this field. When continuous transfers are enabled individual data frame transfers are not necessarily separated by slave deselection (as indicated by the level or pulse on the SELECT line): if the TX FIFO has multiple data frames, data frames are send out without slave deselection. When continuous transfers are not enabled individual data frame transfers are always separated by slave deselection: independent of the availability of TX FIFO data frames."]
    #[inline(always)]
    pub fn set_ssel_continuous(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "Indicates the clock polarity. This field, together with the CPHA field, indicates when MOSI data is driven and MISO data is captured: - CPOL is '0': SCLK is '0' when not transmitting data. - CPOL is '1': SCLK is '1' when not transmitting data."]
    #[inline(always)]
    ...
    #[doc = "Slave select polarity. SSEL_POLARITY0 applies to the outgoing SPI slave select signal 0 (master mode) and to the incoming SPI slave select signal (slave mode). For Motorola and National Semiconductors submodes: '0': slave select is low/'0' active. '1': slave select is high/'1' active. For Texas Instruments submode: '0': high/'1' active precede/coincide pulse. '1': low/'0' active precede/coincide pulse."]
    #[inline(always)]
    ...
    #[doc = "N/A"]
    #[inline(always)]
    pub const fn mode(&self) -> SpiCtrlMode {
        let val = (self.0 >> 24usize) & 0x03;
        SpiCtrlMode::from_bits(val as u8)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn set_mode(&mut self, val: SpiCtrlMode) {
        self.0 = (self.0 & !(0x03 << 24usize)) | (((val.to_bits() as u32) & 0x03) << 24usize);
    }
    #[doc = "Selects one of the four incoming/outgoing SPI slave select signals: - 0: Slave 0, SSEL\\[0\\]. - 1: Slave 1, SSEL\\[1\\]. - 2: Slave 2, SSEL\\[2\\]. - 3: Slave 3, SSEL\\[3\\]. The IP should be disabled when changes are made to this field."]
    #[inline(always)]
    pub const fn ssel(&self) -> u8 {
        let val = (self.0 >> 26usize) & 0x03;
        val as u8
    }
    #[doc = "Selects one of the four incoming/outgoing SPI slave select signals: - 0: Slave 0, SSEL\\[0\\]. - 1: Slave 1, SSEL\\[1\\]. - 2: Slave 2, SSEL\\[2\\]. - 3: Slave 3, SSEL\\[3\\]. The IP should be disabled when changes are made to this field."]
    #[inline(always)]
    pub fn set_ssel(&mut self, val: u8) {
...
impl SpiStatus {
    #[doc = "SPI bus is busy. The bus is considered busy ('1') during an ongoing transaction. For Motorola and National submodes, the busy bit is '1', when the slave selection is activated. For TI submode, the busy bit is '1' from the time the preceding/coinciding slave select is activated for the first transmitted data frame, till the last MOSI/MISO bit of the last data frame is transmitted."]
    #[inline(always)]
    pub const fn bus_busy(&self) -> bool {
        let val = (self.0 >> 0usize) & 0x01;
        val != 0
...
impl UartCtrl {
    ...
    #[doc = "N/A"]
    #[inline(always)]
    pub const fn mode(&self) -> UartCtrlMode {
        let val = (self.0 >> 24usize) & 0x03;
        UartCtrlMode::from_bits(val as u8)
    }
    #[doc = "N/A"]
    #[inline(always)]
    pub fn set_mode(&mut self, val: UartCtrlMode) {
        self.0 = (self.0 & !(0x03 << 24usize)) | (((val.to_bits() as u32) & 0x03) << 24usize);
    }
}
