...
extern "C" {
    ...
    fn PASS_INTERRUPT_SAR_0();
    fn PASS_INTERRUPT_SAR_1();
    fn PASS_INTERRUPT_CTB();
    fn PASS_INTERRUPT_FIFO_0();
    fn PASS_INTERRUPT_FIFO_1();
    fn SCB_0_INTERRUPT();
    fn SCB_1_INTERRUPT();
    fn SCB_2_INTERRUPT();
    fn SCB_4_INTERRUPT();
    ...
    fn TCPWM_0_INTERRUPTS_256();
    fn TCPWM_0_INTERRUPTS_257();
    fn TCPWM_0_INTERRUPTS_258();
    fn TCPWM_0_INTERRUPTS_259();
    fn TCPWM_0_INTERRUPTS_260();
    fn TCPWM_0_INTERRUPTS_261();
    fn TCPWM_0_INTERRUPTS_262();
    fn TCPWM_0_INTERRUPTS_263();
...
#[no_mangle]
pub static __INTERRUPTS: [Vector; 175] = [
    Vector {
    ...
    Vector {
        _handler: PASS_INTERRUPT_SAR_0,
    },
    Vector {
        _handler: PASS_INTERRUPT_SAR_1,
    },
    Vector {
        _handler: PASS_INTERRUPT_CTB,
    },
    Vector { _reserved: 0 },
    Vector {
        _handler: PASS_INTERRUPT_FIFO_0,
    },
    Vector {
        _handler: PASS_INTERRUPT_FIFO_1,
    },
    Vector {
    ...
    Vector { _reserved: 0 },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_256,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_257,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_258,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_259,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_260,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_261,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_262,
    },
    Vector {
        _handler: TCPWM_0_INTERRUPTS_263,
    },
    Vector { _reserved: 0 },
    Vector { _reserved: 0 },
    Vector { _reserved: 0 },
    ...
    Vector {
        _handler: CPUSS_INTERRUPTS_DW0_29,
    },
];
...
pub enum Interrupt {
    ...
    #[doc = "39 - SAR ADC0 interrupt"]
    PASS_INTERRUPT_SAR_0 = 39,
    #[doc = "40 - SAR ADC1 interrupt"]
    PASS_INTERRUPT_SAR_1 = 40,
    #[doc = "41 - individual interrupt per CTB"]
    PASS_INTERRUPT_CTB = 41,
    #[doc = "43 - PASS FIFO0"]
    PASS_INTERRUPT_FIFO_0 = 43,
    #[doc = "44 - PASS FIFO1"]
    PASS_INTERRUPT_FIFO_1 = 44,
    #[doc = "45 - Serial Communication Block #0"]
    SCB_0_INTERRUPT = 45,
    #[doc = "46 - Serial Communication Block #1"]
    SCB_1_INTERRUPT = 46,
    #[doc = "47 - Serial Communication Block #2"]
    SCB_2_INTERRUPT = 47,
    #[doc = "49 - Serial Communication Block #4"]
    SCB_4_INTERRUPT = 49,
    #[doc = "50 - Serial Communication Block #5"]
    SCB_5_INTERRUPT = 50,
    ...
    #[doc = "131 - TCPWM #0, Counter #256"]
    TCPWM_0_INTERRUPTS_256 = 131,
    #[doc = "132 - TCPWM #0, Counter #257"]
    TCPWM_0_INTERRUPTS_257 = 132,
    #[doc = "133 - TCPWM #0, Counter #258"]
    TCPWM_0_INTERRUPTS_258 = 133,
    #[doc = "134 - TCPWM #0, Counter #259"]
    TCPWM_0_INTERRUPTS_259 = 134,
    #[doc = "135 - TCPWM #0, Counter #260"]
    TCPWM_0_INTERRUPTS_260 = 135,
    #[doc = "136 - TCPWM #0, Counter #261"]
    TCPWM_0_INTERRUPTS_261 = 136,
    #[doc = "137 - TCPWM #0, Counter #262"]
    TCPWM_0_INTERRUPTS_262 = 137,
    #[doc = "138 - TCPWM #0, Counter #263"]
    TCPWM_0_INTERRUPTS_263 = 138,
    ...
    #[doc = "174 - CPUSS DataWire #0, Channel #29"]
    CPUSS_INTERRUPTS_DW0_29 = 174,
}
...
unsafe impl Send for SAR1 {}
impl SAR1 {
    #[doc = r"Returns a pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const sar0::RegisterBlock {
        0x409c_0000 as *const _
    }
}
impl Deref for SAR1 {
    type Target = sar0::RegisterBlock;
...
#[doc = "PASS top-level MMIO (AREF, LPOSC, FIFO, INTR, Trigger)"]
pub struct PASS {
    _marker: PhantomData<*const ()>,
}
