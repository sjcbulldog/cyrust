...
#[doc = "Interrupt masked"]
pub mod intr_masked;
#[doc = "SRAM data 0\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_data0](sram_data0) module"]
pub type SRAM_DATA0 = crate::Reg<u32, _SRAM_DATA0>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SRAM_DATA0;
#[doc = "`read()` method returns [sram_data0::R](sram_data0::R) reader structure"]
impl crate::Readable for SRAM_DATA0 {}
#[doc = "`write(|w| ..)` method takes [sram_data0::W](sram_data0::W) writer structure"]
impl crate::Writable for SRAM_DATA0 {}
#[doc = "SRAM data 0"]
pub mod sram_data0;
#[doc = "SRAM data 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sram_data1](sram_data1) module"]
pub type SRAM_DATA1 = crate::Reg<u32, _SRAM_DATA1>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SRAM_DATA1;
#[doc = "`read()` method returns [sram_data1::R](sram_data1::R) reader structure"]
impl crate::Readable for SRAM_DATA1 {}
#[doc = "`write(|w| ..)` method takes [sram_data1::W](sram_data1::W) writer structure"]
impl crate::Writable for SRAM_DATA1 {}
#[doc = "SRAM data 1"]
pub mod sram_data1;
