...
impl R {
    #[doc = "Bits 0:15 - SAR conversion result of the channel. This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
    pub fn inj_result(&self) -> INJ_RESULT_R {
        INJ_RESULT_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bit 27 - The data in this register received a new value (only relevant for UAB, this bit shows the value of the UAB valid bit). This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
    pub fn inj_newvalue(&self) -> INJ_NEWVALUE_R {
        INJ_NEWVALUE_R::new(((self.bits >> 27) & 0x01) != 0)
    }
    #[doc = "Bit 28 - mirror bit of corresponding bit in SAR_INTR register. This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
    pub fn inj_collision_intr_mir(&self) -> INJ_COLLISION_INTR_MIR_R {
        INJ_COLLISION_INTR_MIR_R::new(((self.bits >> 28) & 0x01) != 0)
    }
    #[doc = "Bit 29 - mirror bit of corresponding bit in SAR_INTR register. This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
    pub fn inj_saturate_intr_mir(&self) -> INJ_SATURATE_INTR_MIR_R {
        INJ_SATURATE_INTR_MIR_R::new(((self.bits >> 29) & 0x01) != 0)
    }
    #[doc = "Bit 30 - mirror bit of corresponding bit in SAR_INTR register. This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
    pub fn inj_range_intr_mir(&self) -> INJ_RANGE_INTR_MIR_R {
        INJ_RANGE_INTR_MIR_R::new(((self.bits >> 30) & 0x01) != 0)
    }
    #[doc = "Bit 31 - mirror bit of corresponding bit in SAR_INTR register. This field cannot be read if SAR_CLOCK_SEL.CLOCK_SEL =1."]
    #[inline(always)]
