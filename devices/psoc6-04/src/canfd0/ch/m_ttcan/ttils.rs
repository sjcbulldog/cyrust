#[doc = "Reader of register TTILS"]
pub type R = crate::R<u32, super::TTILS>;
#[doc = "Writer for register TTILS"]
pub type W = crate::W<u32, super::TTILS>;
#[doc = "Register TTILS `reset()`'s with value 0"]
impl crate::ResetValue for super::TTILS {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `AWL_`"]
pub type AWL__R = crate::R<bool, bool>;
#[doc = "Write proxy for field `AWL_`"]
pub struct AWL__W<'a> {
    w: &'a mut W,
}
impl<'a> AWL__W<'a> {
...
impl R {
    ...
    pub fn awl_(&self) -> AWL__R {
        AWL__R::new(((self.bits >> 17) & 0x01) != 0)
    }
