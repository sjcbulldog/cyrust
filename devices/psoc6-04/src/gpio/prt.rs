...
#[doc = "Port SIO configuration register"]
pub mod cfg_sio;
#[doc = "Port input buffer AUTOLVL configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cfg_in_autolvl](cfg_in_autolvl) module"]
pub type CFG_IN_AUTOLVL = crate::Reg<u32, _CFG_IN_AUTOLVL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CFG_IN_AUTOLVL;
#[doc = "`read()` method returns [cfg_in_autolvl::R](cfg_in_autolvl::R) reader structure"]
impl crate::Readable for CFG_IN_AUTOLVL {}
#[doc = "`write(|w| ..)` method takes [cfg_in_autolvl::W](cfg_in_autolvl::W) writer structure"]
impl crate::Writable for CFG_IN_AUTOLVL {}
#[doc = "Port input buffer AUTOLVL configuration register"]
