#[doc = "Reader of register MONITOR_CTL_3"]
pub type R = crate::R<u32, super::MONITOR_CTL_3>;
#[doc = "Writer for register MONITOR_CTL_3"]
pub type W = crate::W<u32, super::MONITOR_CTL_3>;
#[doc = "Register MONITOR_CTL_3 `reset()`'s with value 0"]
impl crate::ResetValue for super::MONITOR_CTL_3 {
    type Type = u32;
    #[inline(always)]
