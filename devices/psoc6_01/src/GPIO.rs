...
impl Prt {
    ...
    #[inline(always)]
    pub const fn cfg_in_gpio5v(self) -> crate::common::Reg<CfgInGpio5v, crate::common::RW> {
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CfgInGpio5v(pub u32);
impl CfgInGpio5v {
